          ...
          <div class="row">
              ...
              <table class="table">
                <thead>
                  <tr>
                    ...
                    <th>Quantity</th>
                    <th>Price</th>
                    <th><a class="icon style2 fa-trash border-0"><span class="label">Delete all</span></a></th>
                  </tr>
                </thead>
                <tbody>
                  <tr>
                    ...
                    <td><a class="icon style2 fa-trash border-0"><span class="label">Delete all</span></a></td>
                  </tr>
                </tbody>
              </table>
            </div>
            <div class="col-12 col-md-3">
              <div class="border border-secondary rounded mb-2 p-2">
                ...
                <p class="text-muted mb-0">Xom 1 thon da hoa xa binh minh huyen khoai chau tinh hung yen</p>
              </div>
